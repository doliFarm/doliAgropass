...
/**
 *	Class to manage PDF template standard_doliagropassaudit
 */
class pdf_standard_doliagropassaudit extends ModelePDFDoliAgroPassAudit
{
	/**
	 ...
	 *
	 *	@param	TCPDF|TCPDI	$pdf     		Object PDF
	 *	@param	DoliAgroPassAudit	$object     	Object to show
