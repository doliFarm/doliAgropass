...
/**
 *	\file       htdocs/core/modules/doliagropass/doc/doc_generic_doliagropassaudit_odt.modules.php
 *	\ingroup    doliagropass
 *	\brief      File of class to build ODT documents for doliagropassaudits
 */

dol_include_once('/doliagropass/core/modules/doliagropass/modules_doliagropassaudit.php');
 ...
 */
class doc_generic_doliagropassaudit_odt extends ModelePDFDoliAgroPassAudit
{
	/**
	 * Issuer
	 * @var Societe
	...
	public function info($langs)
	{
		...
		if ($nbofiles) {
			...
			foreach ($listoffiles as $file) {
				$texte .= '- '.$file['name'].' <a href="'.DOL_URL_ROOT.'/document.php?modulepart=doctemplates&file=doliagropass_doliagropassaudit/'.urlencode(basename($file['name'])).'">'.img_picto('', 'listlight').'</a>';
	 ...
	 *
	 *  @param	DoliAgroPassAudit	$object				Source object to generate document from
	...
	public function write_file($object, $outputlangs, $srctemplatepath = '', $hidedetails = 0, $hidedesc = 0, $hideref = 0)
	{
		...
		if ($conf->doliagropass->dir_output) {
			...
			if (!is_object($object)) {
				$id = $object;
				$object = new DoliAgroPassAudit($this->db);
