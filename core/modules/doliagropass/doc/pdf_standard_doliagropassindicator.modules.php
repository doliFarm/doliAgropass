...
/**
 *  \file       core/modules/doliagropass/doc/pdf_standard.modules.php
...
/**
 *	Class to manage PDF template standard_doliagropassindicator
 */
class pdf_standard_doliagropassindicator extends ModelePDFDoliAgroPassIndicator
{
	/**
	 ...
	 *
	 *	@param	TCPDF|TCPDI	$pdf     		Object PDF
	 *	@param	DoliAgroPassIndicator	$object     	Object to show
	...
	protected function _pagehead(&$pdf, $object, $showaddress, $outputlangs, $outputlangsbis = null)
	{
		...
		// Show Draft Watermark
		if (getDolGlobalString('DOLIAGROPASS_DRAFT_WATERMARK') && $object->status == $object::STATUS_DRAFT) {
			pdf_watermark($pdf, $outputlangs, $this->page_hauteur, $this->page_largeur, 'mm', dol_escape_htmltag(getDolGlobalString('DOLIAGROPASS_DRAFT_WATERMARK')));
		}
