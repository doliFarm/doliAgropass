...
/**
 *       \file       htdocs/doliagropass/ajax/doliagropassindicator.php
 *       \brief      File to return Ajax response on doliagropassindicator list request
 */
...
// Security check
if (!$user->hasRight('doliagropass', 'doliagropassindicator', 'write')) {
	accessforbidden();
}
...
dol_syslog("Call ajax doliagropass/ajax/doliagropassindicator.php");
