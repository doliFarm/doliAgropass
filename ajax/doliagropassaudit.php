...
/**
 *       \file       htdocs/doliagropass/ajax/doliagropassaudit.php
 *       \brief      File to return Ajax response on doliagropassaudit list request
 */
...
// Security check
if (!$user->hasRight('doliagropass', 'doliagropassaudit', 'write')) {
	accessforbidden();
}
...
dol_syslog("Call ajax doliagropass/ajax/doliagropassaudit.php");
