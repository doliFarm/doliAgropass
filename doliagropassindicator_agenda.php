...
/**
 *  \file       doliagropassindicator_agenda.php
 *  \ingroup    doliagropass
 *  \brief      Tab of events on DoliAgroPassIndicator
 */
...
if ($object->id > 0) {
	$title = $langs->trans("DoliAgroPassIndicator")." - ".$langs->trans('Agenda');
	...
	print dol_get_fiche_head($head, 'agenda', $langs->trans("DoliAgroPassIndicator"), -1, $object->picto);
	...
	if (isModEnabled('agenda') && ($user->hasRight('agenda', 'myactions', 'read') || $user->hasRight('agenda', 'allactions', 'read'))) {
		...
		//$cachekey = 'count_events_doliagropassindicator_'.$object->id;
