...
/**
 *  \file       doliagropassaudit_contact.php
 *  \ingroup    doliagropass
 *  \brief      Tab for contacts linked to DoliAgroPassAudit
 */
...
$title = $langs->trans("DoliAgroPassAudit")." - ".$langs->trans('ContactsAddresses');
//$title = $object->ref." - ".$langs->trans('ContactsAddresses');
$help_url = '';
//$help_url='EN:Module_Third_Parties|FR:Module_Tiers|ES:Empresas';
llxHeader('', $title, $help_url, '', 0, 0, '', '', '', 'mod-doliagropass page-card_contact');
...
if ($object->id) {
	...
	print dol_get_fiche_head($head, 'contact', $langs->trans("DoliAgroPassAudit"), -1, $object->picto);
