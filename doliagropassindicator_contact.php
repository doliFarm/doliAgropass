...
/**
 *  \file       doliagropassindicator_contact.php
 *  \ingroup    doliagropass
 *  \brief      Tab for contacts linked to DoliAgroPassIndicator
 */
...
$title = $langs->trans("DoliAgroPassIndicator")." - ".$langs->trans('ContactsAddresses');
...
if ($object->id) {
	...
	print dol_get_fiche_head($head, 'contact', $langs->trans("DoliAgroPassIndicator"), -1, $object->picto);
